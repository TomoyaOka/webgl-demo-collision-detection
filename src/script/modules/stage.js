...
export default class Stage {
  ...
  _setLight() {
    ...
    this.directionalLight = new THREE.DirectionalLight(0xffffff, 0.21);
    this.directionalLight.position.set(0.0, 10.0, 10.0);
